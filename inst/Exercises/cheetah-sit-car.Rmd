...
TITLE GOES HERE: Use the `r df_macro(Batting)`, `r df_macro(Pitching)`, and `r df_macro(Master)` tables in the `r pkg_macro(Lahman)` package to answer the following questions.
