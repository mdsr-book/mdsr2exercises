...
Working with Delta Airlines (before their merger with Northwest Airlines) in 2016, find the airports that the airline services. Hint: query the `mdsr_data("flights")` table, but join on the `mdsr_data("airports")` table to retrieve the name and location of the airport
